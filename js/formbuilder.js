                ...
                , init: function (element, options) {
                        ...
                        this.$element.load(templateUrl, $.proxy(function (response, status, xhr) {
                                ...
                                if (this.options.isPluginOnly) {
                                        ...
                                        this.initDialog();
                                        this.reAttachEvents();
                                          this.$element.parents('body').find('#wpfuser_id_lists').html('User id: '+ this.options.userId)
                ...
                loadForm: function () {
                        ...
                        this.getAjaxCORS(reqObj, $.proxy(function (data) {
                                ...
                                if (data) {
                                        ...
                                        this.$element.find('.wpfuser_id').html('User id: '+ this.options.userId).show();
                                        if(this.options.pluginType === 'wordpress'){
                                                ...
                                                $.each(data.forms, function (key, formsval) {
                                                        $.each(formsval, function (key, values) {
                                                          ...
                                                          var res = shortCode.split('/')[5];
                                                                ...
                                                                if (tableHTMl) {
                                                                        tableHTMl += '<tr><td width="80%"><a form-purl="' + values[0]["formPreviewURL"] + '?preview=Y" class="preview-form showtooltip" title="Click to preivew form">' + values[0].name + '</a></td><td width="20%"><a class="btn-green right edit-form showtooltip" title="Click to edit form" formid=' + values[0]["formId.encode"] + '><i class="icon edit"></i></a><a class="btn-blue right embed_code showtooltip" title="Click to view embed code"  form-snippet=' + values[0]["formId.encode"] + '><textarea  style="display:none;">' + values[0]["snippet"] + '</textarea><i class="icon embed24"></i></a><a class="btn-blue right formlinks showtooltip" form-url ="' + values[0]["formPreviewURL"] + '" title="Click to view form links"><i class="icon link24"></i></a><a style="display:none;" class="btn-blue right shortcodelinks showtooltip" form-url ="'+res+'" title="Click to view form shortcode"><i class="icon shortcode24"></i></a><a class="btn-red right deletelistform showtooltip" title="Click to delete form" formid=' + values[0]["formId.encode"] + '><i class="icon delete"></i></a></td></tr>';
                                                                } else {
                                                                        tableHTMl = '<tr><td width="80%" ><a form-purl="' + values[0]["formPreviewURL"] + '?preview=Y" class="preview-form showtooltip" title="Click to preivew form">' + values[0].name + '</a></td><td width="20%"><a class="btn-green right edit-form showtooltip" title="Click to edit form" formid=' + values[0]["formId.encode"] + '><i class="icon edit"></i></a><a class="btn-blue right embed_code showtooltip" title="Click to view embed code" form-snippet=' + values[0]["formId.encode"] + '><textarea style="display:none;">' + values[0]["snippet"] + '</textarea><i class="icon embed24"></i></a><a class="btn-blue right formlinks showtooltip" form-url ="' + values[0]["formPreviewURL"] + '" title="Click to view form links"><i class="icon link24"></i></a><a style="display:none;" class="btn-blue right shortcodelinks showtooltip" form-url ="'+res+'" title="Click to view form shortcode"><i class="icon shortcode24"></i></a><a class="btn-red right deletelistform showtooltip" title="Click to delete form" formid=' + values[0]["formId.encode"] + '><i class="icon delete"></i></a></td></tr>'
                                                                }
